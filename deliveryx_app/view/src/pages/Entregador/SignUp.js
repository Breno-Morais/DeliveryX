...
function SignUp() {
  ...
  async function handleSingIn(event)
  {
    ...
    await fetch('/registrarEntregador', {
      method: 'POST',
  ...
  return (
    <div className="container-fluid" style={{backgroundColor: '#FDC500'}}>
      <div className="row h-100 align-items-center justify-content-center pad-vh" style={{ minHeight: '100vh'}}>
        <div className="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
          <div className="bg-light rounded p-4 p-sm-5 my-4 mx-3" style={{paddingRight: '1rem', paddingLeft: '1rem', paddingTop:'2.5rem', paddingBottom:'2.5rem'}}>
            ...
            <button type="submit" className="btn btn-primary py-3 w-100 mb-4" onClick={handleSingIn}>Inscreva-se</button>
            <p className="text-center mb-0">Já tem uma conta?<Link to="/loginCourier"> Conecte-se</Link></p>
          </div>
        </div>
      </div>
    </div>
